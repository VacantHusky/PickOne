...
if (signingPropertiesFile.isFile && !hasReleaseSigning) {
    error("keystore.properties must define storeFile, storePassword, keyAlias, and keyPassword")
}

android {
    namespace = "com.playdice.pickone"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.playdice.pickone"
        minSdk = 26
        targetSdk = 36
        versionCode = 3
        versionName = "1.0.2"
